...
class Substance :
    ...
    def get_vaporization_curve(self,
        ...
        T = np.arange(self.T_triple,self.T_crit,step)
    ...
    def get_melting_curve(self,
        ...
        P = np.logspace(math.log10(self.p_triple + 0.01), math.log10(s.keyed_output(CP.iP_max)),step)
    ...
    def get_sublimation_curve(self,
        ...
        if self.name == "Water" :
            ...
            T = np.arange(190, self.T_triple, step)
            p_n = 611.657
            T_n = 273.16
            Theta = T/T_n
            a_1 = -13.928169
